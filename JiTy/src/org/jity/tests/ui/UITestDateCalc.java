...
public class UITestDateCalc {
	...
	private Shell sShell = null;  //  @jve:decl-index=0:visual-constraint="18,11"
	...
	private void createSShell() {
		...
		gridLayout.numColumns = 18;
		sShell = new Shell();
		sShell.setText("Dates calculate tests");
		sShell.setLayout(gridLayout);
		sShell.setSize(new Point(540, 764));
		...
		Label filler101 = new Label(sShell, SWT.NONE);
		...
		TableColumn tableColumn14 = new TableColumn(tableDays, SWT.NONE);
		tableColumn14.setWidth(30);
		tableColumn14.setText("#");
	...
	public void updateTabDays(PersonnalCalendar persCal) {
		
		tableDays.removeAll();
		
		for (int day=1;day<32;day++) {
			TableItem line = new TableItem(tableDays, SWT.NONE);
			line.setText(new String[]{String.valueOf(day),"","","","","","","","","","","",""});
		}
